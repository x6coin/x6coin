...
RESOURCES += src/qt/x6coin.qrc src/qt/x6coin_locale.qrc

TRANSLATIONS += src/qt/locale/x6coin_bg.ts \
                src/qt/locale/x6coin_de.ts \
                src/qt/locale/x6coin_en.ts \
                src/qt/locale/x6coin_es.ts \
                src/qt/locale/x6coin_fi.ts \
                src/qt/locale/x6coin_fr.ts \
                src/qt/locale/x6coin_it.ts \
                src/qt/locale/x6coin_ja.ts \
                src/qt/locale/x6coin_pl.ts \
                src/qt/locale/x6coin_pt.ts \
                src/qt/locale/x6coin_ru.ts \
                src/qt/locale/x6coin_sk.ts \
                src/qt/locale/x6coin_sv.ts \
                src/qt/locale/x6coin_vi.ts \
                src/qt/locale/x6coin_zh_CN.ts \
                src/qt/locale/x6coin_zh_TW.ts
