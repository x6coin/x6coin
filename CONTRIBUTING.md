Contributing to X6Coin Core
============================

The X6Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the X6Coin Core project, and is not to be
confused with overall X6Coin Network Protocol consensus changes.

Whether a pull request is merged into X6Coin Core rests with the project merge
...
Patches that change X6Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the X6Coin consensus, it must have been
...
The project leader is the release manager for each X6Coin Core release.
