...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* X6Coin features */
        {"x6coin", "masternode", &masternode, true, true, false},
        {"x6coin", "listmasternodes", &listmasternodes, true, true, false},
        {"x6coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"x6coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"x6coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"x6coin", "masternodedebug", &masternodedebug, true, true, false},
        {"x6coin", "startmasternode", &startmasternode, true, true, false},
        {"x6coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"x6coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"x6coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"x6coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"x6coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"x6coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"x6coin", "mnbudget", &mnbudget, true, true, false},
        {"x6coin", "preparebudget", &preparebudget, true, true, false},
        {"x6coin", "submitbudget", &submitbudget, true, true, false},
        {"x6coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"x6coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"x6coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"x6coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"x6coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"x6coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"x6coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"x6coin", "checkbudgets", &checkbudgets, true, true, false},
        {"x6coin", "mnsync", &mnsync, true, true, false},
        {"x6coin", "spork", &spork, true, true, false},
        {"x6coin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"x6coin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use x6coind, or the -server option to x6coin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> x6coin-cli " + methodname + " " + args + "\n";
}
