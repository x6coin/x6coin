...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 X6COIN at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zX6 send
enum ZerocoinSpendStatus {
    ZX6COIN_SPEND_OKAY = 0,                            // No error
    ZX6COIN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZX6COIN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZX6COIN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZX6COIN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZX6COIN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZX6COIN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZX6COIN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZX6COIN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZX6COIN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZX6COIN_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZX6COIN_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZX6COIN_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZX6COIN_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZX6COIN_SPENT_USED_ZX6COIN = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZX6CoinAutoBackups(bool fEnabled)
    {
