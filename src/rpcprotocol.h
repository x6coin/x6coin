...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! X6Coin is not connected
    ...
    RPC_WALLET_PASSX6COINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
