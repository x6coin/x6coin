                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("X6Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a X6Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and x6coin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About X6Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about X6Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for X6Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your X6Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified X6Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a X6Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the X6Coin Core help message to get a list with possible X6Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("X6Coin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("X6Coin Core"); // default title
...
/** Creates context menu, its actions, and x6coins up all the relevant signals for mouse events. */
