...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("X6Coin Core x6coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  x6coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded x6coin transaction") + "\n" +
                               "  x6coin-tx [options] -create [commands]   " + _("Create hex-encoded x6coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded x6coin transaction
